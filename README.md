...
Option A — inline:
```bash
AUTH_TOKEN=mytoken123 node index.js
```

Option B — export once:
```bash
export AUTH_TOKEN=mytoken123
node index.js
```

Option C — edit the file (not recommended):
Open `index.js` and replace `"YOUR_AUTH_TOKEN_HERE"` with your token.
